package com.example.alessandro.computergraphicsexample.alternative.control;
...
public class FreeTouchController implements View.OnTouchListener {
    ...
    private AlternativeShip3D ship3D;
    ...
    public FreeTouchController(Activity activity, AlternativeShip3D ship3D, Rect bound, float maxModulo) {
        this.ship3D = ship3D;
        minX = bound.left;
        maxX = bound.right;
