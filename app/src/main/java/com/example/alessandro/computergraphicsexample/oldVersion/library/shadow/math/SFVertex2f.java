package com.example.alessandro.computergraphicsexample.oldVersion.library.shadow.math;

/**
 * A value of 2 elements. A vector or a vertex (x,y). Add com.example.alessandro.computergraphicsexample.alternative, specific, more fast
