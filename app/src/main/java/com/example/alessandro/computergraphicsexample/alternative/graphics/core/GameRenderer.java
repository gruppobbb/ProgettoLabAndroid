...
import com.example.alessandro.computergraphicsexample.alternative.objectsModel.gameModels.MobsModel;
import com.example.alessandro.computergraphicsexample.alternative.objectsModel.gameModels.ShipModel;
import com.example.alessandro.computergraphicsexample.alternative.objectsModel.obj.ObjModelBuilder;
...
public class GameRenderer implements GLSurfaceView.Renderer{
    ...
    private AlternativeShip3D ship;
    ...
    /**
     * Renderer ottimizzato per il disegno di una modalità singleplayer con N {@link AlternativeMob3D}
     * recuperati dal {@link MobsManager}, con una inquadratura definita dalla {@link GameCamera},
     * con una {@link AlternativeShip3D} controllata dal giocatore.
     * @param context
     ...
     */
    public GameRenderer(Context context, MobsManager mobsManager, GameCamera camera, Light sunLight, AlternativeShip3D ship) {
    ...
    private void drawMobs(){
        ...
        if(mobs.size() > 0 ){
            ...
            for(Mob mob : mobs){
                ...
                if( mob != null ){
                    program.loadModelMatrix(((AlternativeMob3D)mob).getModelMatrix());
